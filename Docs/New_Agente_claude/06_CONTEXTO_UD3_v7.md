...
> **Versión:** v7 (4 plantillas operativas para UD3 disponibles)
...
- Patrón obligatorio: descarga del binario `spark-3.5.4-bin-hadoop3.tgz` desde `archive.apache.org` + `findspark` + variables de entorno (ver bloque 7.7).
...
```python
# Descarga del binario Spark compilado contra Hadoop 3
